            ...
            <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <Link to="/">
                            <div
                                className="h-16 w-56 bg-contain bg-no-repeat"
                        ...
                        <div className="flex mt-8 space-x-6 text-blue-200">
                            ...
                            <a className="hover:text-white transition-colors duration-300" href="https://instagram.com" target="_blank" rel="noreferrer">
                            ...
                            <a className="hover:text-white transition-colors duration-300" href="https://twitter.com" target="_blank" rel="noreferrer">
